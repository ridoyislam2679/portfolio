...
if ($model_name) {
	...
	$sql = "SELECT mobile_id FROM mobiles WHERE LOWER(model_name) = LOWER(?)";
	...
	$id = $row['mobile_id'];
	//$sql = "SELECT *, brand_name FROM mobile_specification INNER JOIN brands ON mobile_specification.brand_id = brands.brand_id WHERE mobile_id = ?";
	$sql = "SELECT mobile_specification.*, brands.brand_name, mobiles.model_name, mobiles.battery_helth, mobiles.phone_condition, mobiles.price, mobiles.release_date, mobiles.main_image FROM mobile_specification INNER JOIN brands ON mobile_specification.brand_id = brands.brand_id INNER JOIN mobiles ON mobile_specification.mobile_id = mobiles.mobile_id WHERE mobile_specification.mobile_id = ?";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([$id]);
