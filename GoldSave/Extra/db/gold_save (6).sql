...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2026 at 09:08 PM
...
(11, 17, 220.00, 0.04, 0, '2026-04-17 04:49:14'),
(12, 17, 100.00, 0.02, 0, '2026-04-17 04:49:57'),
(13, 17, 1000.00, 0.18, 10, '2026-04-17 04:54:16'),
(14, 17, 500.00, 0.09, 10, '2026-04-17 04:54:31'),
(15, 17, 200.00, 0.04, 0, '2026-04-17 05:00:10');
...
(5, 6, 0.90, NULL, 'করিয়ার ম্যান ৫', '01810000005', 'বরিশাল, বাংলাদেশ', '2024-03-22 10:20:00', '2024-03-28', 'pending'),
(6, 8, 2.50, NULL, 'করিয়ার ম্যান ৬', '01810000006', 'সিলেট, বাংলাদেশ', '2024-04-01 07:50:00', '2024-04-07', 'processing'),
(7, 9, 0.60, NULL, 'করিয়ার ম্যান ৭', '01810000007', 'ময়মনসিংহ, বাংলাদেশ', '2024-04-05 04:30:00', NULL, 'pending'),
...
(13, 17, 1.00, 'biscuit', 'Md Hridoy Islam', '01763029679', 'gopalpur road, waliya, lalpur, natore', '2026-04-17 16:54:52', NULL, 'pending');
...
(5, 17, 'https://www.facebook.com/', '2026-04-27 03:10:42', 'pending'),
(6, 17, 'https://www.facebook.com/hridoy42679', '2026-04-17 03:16:20', 'pending');
...
(12, 17, '01763029679', 30.00, '2026-04-16 17:10:13', 'pending');
...
(17, 'Md Hridoy', '1230', '123@gmail.com', 'male', '91856214', 16, '$2y$10$Xl1GyehZTOUDTDXiI4g2BOx/RHQH6GU2jdfXoP9njSppv9zsOg6Pq', 'login-Image.png', 'active', '2026-04-16 14:33:45'),
...
--
ALTER TABLE `bonus`
  MODIFY `bonus_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `bonus_coin`
--
ALTER TABLE `bonus_coin`
  MODIFY `bonus_coin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
