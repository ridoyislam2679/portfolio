...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (!in_array($gender, ['male', 'female', 'other'])) {
        ...
        if ($stmt->fetch()) {
            ...
            $success = $stmt->execute([$username, $email, $number, $hashedPassword, $gender]);
...
<head>
    ...
    <style>
        /* Additional styles for gender radio */
        .gender-group {
            margin-bottom: 20px;
        }
        ...
        .gender-option .fa-mars { color: #4a9eff; }
        .gender-option .fa-venus { color: #ff69b4; }
        .gender-option .fa-genderless { color: #FFD700; }
        ...
        <div class="form-container">
            ...
            <form id="registerForm" method="POST" action="register.php" autocomplete="off">
                <div class="form-group">
                    ...
                    <input type="text" name="username" id="fullname" class="form-control" placeholder="Enter your full name" autocomplete="off" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="phone-input">
                        <input type="tel" name="mobile" id="regMobile" class="form-control phone-number" placeholder="1234567890" maxlength="10" autocomplete="off" disabled value="<?php echo isset($number) ? htmlspecialchars($number) : ''; ?>">
                    </div>
                </div>
