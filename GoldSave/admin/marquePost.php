...
<head>
    ...
    <title>Marque Posts - Admin Panel</title>
        ...
        <div class="settings-card">
            ...
            <form id="postForm" method="POST" action="" enctype='multipart/form-data' autocomplete="off">
                ...
                <button type="submit" name="submitPost" class="submit-btn">
                    <i class="fas fa-paper-plane"></i> Offer
                </button>
            </form>
			<?php 
				if(isset($_POST['submitPost'])){
					...
					$stmt = $pdo->prepare("INSERT INTO marque (marque_text) VALUES (?)");
					$success = $stmt->execute([$dsc]);
