                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="withdrawTable" width="100%" cellspacing="0">
							...
							<tbody>
								<?php 
									$select = "SELECT * FROM tasks WHERE task_status = 1";
									...
									while($history = $historyQuery->fetch()){
										...
										?>
											<tr>
												...
												<td> <p><?php echo $history['title']; ?></p></td>
												<td> <p><?php echo $history['description']; ?></p></td>
												<td> <p><?php echo $history['target_url']; ?></p></td>
												<td><span class="prize-won"><?php echo $history['task_earn']; ?></span></td>
												<td> <img src="task/<?php echo $history['task_image']; ?>" height="70px" width="70px"></td>
												<td class="status-pending">
													<form class="action-form" method="POST">
														<input type="hidden" name="hidden_id" value="<?php echo $history['task_id'] ?>">
						...
						<?php 
							if(isset($_POST['delete'])){
								...
								$sql ="UPDATE tasks SET task_status = '0' WHERE task_id = ?";
